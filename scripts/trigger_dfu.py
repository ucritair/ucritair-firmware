#!/usr/bin/env python3
"""
Trigger DFU mode or reboot on a uCrit device via USB serial.

Sends a 4-byte magic sequence over the USB CDC ACM serial port.
...
def main():
    parser = argparse.ArgumentParser(
        description="Trigger DFU mode or reboot on uCrit via USB serial"
    )
    parser.add_argument(
        "--reboot",
        action="store_true",
