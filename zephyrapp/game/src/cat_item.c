...
{
	// TOOLS
	padkaprow_item = CAT_item_init(CAT_ITEM_TYPE_FOOD, "Pad Ka Prow", padkaprow_sprite, 1);
	CAT_tool_init(padkaprow_item, padkaprow_sprite, 3, 0, 0);
	...
	pill_foc_item = CAT_item_init(CAT_ITEM_TYPE_FOOD, "Focus Pill", pill_foc_sprite, 1);
	CAT_tool_init(pill_foc_item, pill_foc_sprite, 0, 1, 0);

	pill_spi_item = CAT_item_init(CAT_ITEM_TYPE_FOOD, "Spirit Pill", pill_spi_sprite, 1);
	...
	CAT_tool_init(toy_duck_item, toy_duck_sprite, 0, 0, 3);

	toy_baseball_item = CAT_item_init(CAT_ITEM_TYPE_TOY, "Baseball", toy_baseball_sprite, 1);
	CAT_tool_init(toy_baseball_item, toy_baseball_sprite, 0, 0, 3);

	toy_basketball_item = CAT_item_init(CAT_ITEM_TYPE_TOY, "Basketball", toy_basketball_sprite, 1);
	CAT_tool_init(toy_basketball_item, toy_basketball_sprite, 0, 0, 3);

	toy_golf_item = CAT_item_init(CAT_ITEM_TYPE_TOY, "Golf Ball", toy_golf_sprite, 1);
	CAT_tool_init(toy_golf_item, toy_golf_sprite, 0, 0, 3);

	toy_puzzle_item = CAT_item_init(CAT_ITEM_TYPE_TOY, "Puzzle", toy_puzzle_sprite, 1);
	...
	// PROPS
	gpu_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Ethereum Farm", gpu_sprite, 1);
	CAT_prop_init(gpu_item, 3, 1, true);

	uv_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "UV Lamp", uv_sprite, 1);
	...
	fan_b_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Modern Fan", fan_b_sprite, 1);
	CAT_prop_init(fan_b_item, 2, 1, true);

	lantern_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Lantern", lantern_sprite, 1);
	...
	stool_wood_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Wood Stool", stool_wood_sprite, 1);
	CAT_prop_init(stool_wood_item, 2, 1, true);

	stool_stone_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Stone Stool", stool_stone_sprite, 1);
	CAT_prop_init(stool_stone_item, 2, 1, true);

	stool_gold_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Gold Stool", stool_gold_sprite, 1);
	...
	succulent_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Succulent", succulent_sprite, 1);
	CAT_prop_init(succulent_item, 1, 1, true);

	bush_plain_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Bush", bush_plain_sprite, 1);
	CAT_prop_init(bush_plain_item, 2, 1, true);

	bush_daisy_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Daisy Bush", bush_daisy_sprite, 1);
	CAT_prop_init(bush_daisy_item, 2, 1, true);

	bush_lilac_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Lilac Bush", bush_lilac_sprite, 1);
	...
	crystal_green_lg_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Green Crystal", crystal_green_lg_sprite, 1);
	CAT_prop_init(crystal_green_lg_item, 2, 1, true);

	crystal_purple_lg_item = CAT_item_init(CAT_ITEM_TYPE_PROP, "Purple Crystal", crystal_purple_lg_sprite, 1);
