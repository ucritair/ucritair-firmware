...
The ``cat5340/nrf5340/cpuapp`` build target provides support for the application
core on the nRF5340 SoC. The ``cat5340/nrf5340/cpunet`` build target provides
...
The ``cat5340/nrf5340/cpuapp`` board configuration supports the following
hardware features:
...
The ``cat5340/nrf5340/cpunet`` board configuration supports the following
hardware features:
...
Applications built for the ``cat5340/nrf5340/cpuapp`` board by default
...
1. Build the Non-Secure Zephyr application
   for the application core using ``-DBOARD=cat5340/nrf5340/cpuapp/ns``.
...
1. Build the Secure Zephyr application for the application core
   using ``-DBOARD=cat5340/nrf5340/cpuapp`` and
...
2. Build the Non-Secure Zephyr application for the application core
   using ``-DBOARD=cat5340/nrf5340/cpuapp/ns``.
...
and :ref:`application_run`), using ``-DBOARD=cat5340/nrf5340/cpuapp`` for
the firmware running on the nRF5340 application core, and using
``-DBOARD=cat5340/nrf5340/cpunet`` for the firmware running
...
:zephyr_file:`boards/nordic/cat5340/nrf5340_cpuapp_common.dtsi`.
