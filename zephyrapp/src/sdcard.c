...
enum sdcard_result write_log_to_sdcard()
{
	...
	int len = snprintf(buf, sizeof(buf), "Timestamp,FLAGS,CO2,CO2_UNCOMP,PM1.0,PM2.5,PM4.0,PM10,PN0.5,PN1.0,PN2.5,PN4.0,PN10.0,TempC,RH,VOC,NOX,PRESSURE\n");
